...
public class YunshuRuntimeService {
    ...
    private boolean isNewOldCustomerQuestion(String content) {
        return questionSemantics.isNewOldCustomerQuestion(content);
    }

    private boolean isOwnerOpportunityRankingQuestion(String content) {
        return questionSemantics.isOwnerOpportunityRankingQuestion(content);
    }

    private boolean isStatusAmountAggregationQuestion(String content) {
        return questionSemantics.isStatusAmountAggregationQuestion(content);
    }

    private boolean isAmountAggregationQuestion(String content) {
        return questionSemantics.isAmountAggregationQuestion(content);
    }
    ...
    private boolean isAmountRankingQuestion(String content) {
        return questionSemantics.isAmountRankingQuestion(content);
    }
    ...
    private boolean asksAggregation(String value) {
        return questionSemantics.isAmountAggregationQuestion(value);
    }
